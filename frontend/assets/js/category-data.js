// category-data.js - Kategori detayları için genişletilmiş veri yapısı

// Detaylı Kategori Tanımlamaları
...
const detailedTools = {
    // Görsel Üretimi Araçları
    "midjourney": {
        id: "midjourney",
        name: "Midjourney",
        description: "Metin komutlarından yüksek kaliteli, sanatsal görseller üreten popüler bir AI görsel üretim aracı. Discord üzerinden kullanılabilir.",
    ...
    "dalle": {
        id: "dalle",
        name: "DALL-E",
        description: "OpenAI'nin geliştirdiği, metin açıklamalarından gerçekçi görseller üreten güçlü bir AI görsel üretim modeli. ChatGPT Plus ile birlikte kullanılabilir.",
    ...
    "stable-diffusion": {
        ...
        description: "Açık kaynaklı bir metin-görsel dönüştürme modeli. Yerel olarak çalıştırılabilir ve özelleştirilebilir, çeşitli versiyonları ve modelleri mevcuttur.",
    ...
    "leonardo-ai": {
        id: "leonardo-ai",
        name: "Leonardo.AI",
        description: "Yaratıcı profesyoneller için geliştirilmiş, yüksek kaliteli görsel içerik oluşturma platformu. Oyun assetleri, illüstrasyonlar ve konsept tasarımları üretebilir.",
        ...
        bgColor: "#252836",
        textColor: "#ffffff",
        tags: ["Görsel Üretimi", "3D Model", "Oyun Assetleri"],
        priceType: "freemium",
        priceText: "Freemium",
        rating: 4.6,
        isPopular: false,
    ...
    "bing-image-creator": {
        ...
        description: "Microsoft'un DALL-E teknolojisini kullanarak oluşturduğu ücretsiz metin-görsel dönüştürme aracı. Bing arama motoru üzerinden erişilebilir.",
        ...
        bgColor: "#e6f2ff",
        textColor: "#0078d4",
        tags: ["Görsel Üretimi", "Web Tabanlı", "Ücretsiz Erişim"],
        priceType: "free",
        priceText: "Ücretsiz",
        rating: 4.5,
        isPopular: false,
    ...
    "adobe-firefly": {
        id: "adobe-firefly",
        name: "Adobe Firefly",
        description: "Adobe'un metin tabanlı görsel oluşturma aracı. Ticari kullanım için güvenli içerik üretmeye odaklanmıştır ve Adobe Creative Cloud ile entegre çalışır.",
        ...
        bgColor: "#2D001F",
        textColor: "#ffffff",
        tags: ["Görsel Üretimi", "Ticari Kullanım", "Adobe Entegrasyonu"],
        priceType: "premium",
        priceText: "Ücretli",
        rating: 4.7,
        isPopular: false,
    ...
    "canva-ai": {
        id: "canva-ai",
        name: "Canva AI",
        description: "Canva'nın tasarım platformuna entegre edilmiş yapay zeka araçları. Text to Image, Magic Media ve Magic Design gibi özelliklerle görsel içerik oluşturabilirsiniz.",
        ...
        bgColor: "#00C4CC",
        textColor: "#ffffff",
        tags: ["Görsel Üretimi", "Tasarım", "Sosyal Medya"],
        priceType: "freemium",
        priceText: "Freemium",
        rating: 4.5,
        isPopular: false,
    ...
    "nightcafe-creator": {
        ...
        description: "Kullanıcı dostu arayüzü ile metin tabanlı görsel oluşturma platformu. Stable Diffusion, DALL-E ve diğer modelleri tek bir platformda birleştirir.",
        ...
        bgColor: "#4B0082",
        textColor: "#ffffff",
        tags: ["Görsel Üretimi", "Sanat", "Çoklu Model"],
        priceType: "freemium",
        priceText: "Freemium",
        rating: 4.3,
        isPopular: false,
     ...
     "chatgpt": {
        id: "chatgpt",
        name: "ChatGPT",
        description: "OpenAI tarafından geliştirilen ileri düzey metin üretim aracı. Blog yazıları, metin özetleme, yazı düzenleme ve yaratıcı içerikler üretebilir.",
        ...
        bgColor: "#00a67d",
        textColor: "#ffffff",
        tags: ["Metin Üretimi", "İçerik Yazımı", "Chatbot"],
        priceType: "freemium",
        priceText: "Freemium",
        rating: 4.9,
        isPopular: true,
        isNew: false,
        category: "metin-uretimi",
        dateAdded: "2023-02-10"
    },
    "jasper-ai": {
        id: "jasper-ai",
        name: "Jasper AI",
        description: "Pazarlama ve içerik üretimi için optimize edilmiş yapay zeka destekli yazı asistanı.",
        ...
        bgColor: "#5429ff",
        textColor: "#ffffff",
        tags: ["Metin Üretimi", "SEO", "Pazarlama"],
        priceType: "premium",
        priceText: "Ücretli",
        rating: 4.8,
        isPopular: true,
    ...
    "rytr": {
        id: "rytr",
        name: "Rytr",
        description: "Uygun fiyatlı, hızlı ve etkili metin yazımı için yapay zeka destekli içerik oluşturucu.",
        ...
        bgColor: "#f4a261",
        textColor: "#ffffff",
        tags: ["Metin Üretimi", "Hikaye Yazımı", "SEO"],
        priceType: "freemium",
        priceText: "Freemium",
        rating: 4.6,
        isPopular: false,
    ...
    "copy-ai": {
        id: "copy-ai",
        name: "Copy.ai",
        description: "Kreatif içerikler oluşturmak için yapay zeka destekli metin üretim platformu.",
        ...
        bgColor: "#8e44ad",
        textColor: "#ffffff",
        tags: ["Metin Üretimi", "Reklam Metinleri", "Pazarlama"],
        priceType: "freemium",
        priceText: "Freemium",
        rating: 4.7,
        isPopular: false,
    ...
    "writesonic": {
        id: "writesonic",
        name: "Writesonic",
        description: "Blog yazıları, ürün açıklamaları ve reklam metinleri için AI destekli yazı aracı.",
    ...
    "notion-ai": {
        id: "notion-ai",
        name: "Notion AI",
        description: "Notion’un içerik yazımı ve düzenleme için entegre ettiği AI destekli yazı asistanı.",
        ...
        bgColor: "#202124",
        textColor: "#ffffff",
        tags: ["Metin Üretimi", "Doküman Yazımı", "AI Asistan"],
        priceType: "freemium",
        priceText: "Freemium",
        rating: 4.5,
        isPopular: false,
    ...
    "sudowrite": {
        id: "sudowrite",
        name: "Sudowrite",
        description: "Yazarlar için yapay zeka destekli yaratıcı yazım aracı.",
        ...
        bgColor: "#ff4081",
        textColor: "#ffffff",
        tags: ["Metin Üretimi", "Yaratıcı Yazım", "Roman Yazımı"],
        priceType: "premium",
        priceText: "Ücretli",
        rating: 4.6,
        isPopular: false,
    ...
    "hypotenuse-ai": {
        id: "hypotenuse-ai",
        name: "Hypotenuse AI",
        description: "E-ticaret ve blog içerikleri üretmek için geliştirilmiş yapay zeka yazı asistanı.",
        ...
        bgColor: "#5d4037",
        textColor: "#ffffff",
        tags: ["Metin Üretimi", "E-Ticaret", "SEO"],
        priceType: "premium",
        priceText: "Ücretli",
        rating: 4.5,
        isPopular: false,
...
window.aiToolsDetailedData = {
    categoryDetails: categoryDetails,
    detailedTools: detailedTools,
    
    // Yardımcı fonksiyonlar
    getCategoryDetail: function(categoryId) {
        return this.categoryDetails[categoryId] || null;
    },
    
    getToolDetail: function(toolId) {
        return this.detailedTools[toolId] || null;
    },
    
    getToolsByCategory: function(categoryId) {
        return Object.values(this.detailedTools).filter(tool => tool.category === categoryId);
    },
    
    // Filtreleme fonksiyonları
    filterToolsByPrice: function(tools, priceType) {
        if (priceType === 'all') return tools;
        return tools.filter(tool => tool.priceType === priceType);
    },
    
    // Sıralama fonksiyonları
    sortTools: function(tools, sortType) {
        switch (sortType) {
            case 'popular':
                return [...tools].sort((a, b) => b.rating - a.rating);
            case 'newest':
                return [...tools].sort((a, b) => new Date(b.dateAdded) - new Date(a.dateAdded));
            case 'name':
    ...
    // Arama fonksiyonu
    searchTools: function(tools, searchTerm) {
